...
<p><a href="README.md">English</a> · <strong>Türkçe</strong></p>
...
Pazarlama görsellerini (OG + banner, TR & EN) üretmek için: `node scripts/generate-images.mjs`.
...
Dil dosyaları `public/_locales/{en,tr}/messages.json` içindedir — Chrome, dili
tarayıcının arayüz diline göre otomatik seçer (yedek dil İngilizce'dir).
